...
document.addEventListener("DOMContentLoaded", async () => {
            ...
            data.transactions.forEach(tx => {
                ...
                <td class="editcol" hidden>
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <button
                            class="btn btn-sm tx-cancel tx-button p-0 d-none"
                            data-tx-id="${tx.id}"
                            type="button">
                        ...
                        <button
                            class="btn btn-sm tx-check tx-button p-0 d-none"
                            data-tx-id="${tx.id}"
                            type="button">
    ...
    document.addEventListener("click", (e) => {
        ...
        const cancelBtn = e.target.closest(".tx-cancel .fa-xmark,"); // X button
