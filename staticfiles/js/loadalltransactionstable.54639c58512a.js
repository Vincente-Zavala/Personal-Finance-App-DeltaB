    ...
    document.addEventListener("click", (e) => {
        ...
        if (editBtn) {
            ...
            typeSelect.addEventListener("change", () => {
                ...
                const currentCategoryOriginal = categorySelect.dataset.originalValue || categorySelect.value;
        ...
        // ---- CANCEL BUTTON (X) CLICK ----
        if (cancelBtn) {
            console.log("Within cancel button handler");
            const row = cancelBtn.closest(".transaction-row");
            if (!row) return;
            ...
            displays.forEach((display, i) => {
                ...
                if (input.tagName === "SELECT") {
                    if (input.name === "category" && input.dataset.originalValue) {
                        // For category, use the original value
            ...
            // Hide input fields, show display fields, and exit edit mode
            inputs.forEach(i => i.classList.add("d-none"));
            displays.forEach(d => d.classList.remove("d-none"));
            buttons.forEach(b => b.classList.add("d-none"));
            if (editButton) editButton.classList.remove("d-none");
