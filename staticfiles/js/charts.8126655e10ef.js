...
document.addEventListener("DOMContentLoaded", () => {
    ...
    try {
        ...
        // Make a lookup dictionary so we can easily get a chart by name
        const chartsByType = Object.fromEntries(
        chartsData.map(obj => [obj.type.toLowerCase(), obj])
);
    ...
    chartsData.forEach((chartObj, index) => {
        ...
        // Example: render only the "Expenses" chart
        const expensesData = chartsByType["expense"];
        renderDoughnutChart("myExpensesChart", expensesData);
