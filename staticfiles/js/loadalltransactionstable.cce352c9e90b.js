...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    document.addEventListener("click", (e) => {
        ...
        if (cancelBtn) {
            ...
            console.log("Category Select First:", categorySelect);
            console.log("Category Select Original:", categorySelect.dataset.originalValue);
            if (categorySelect && categorySelect.dataset.originalValue) {
                categorySelect.value = categorySelect.dataset.originalValue;
                console.log("Category Select Last:", categorySelect.value);
            }
