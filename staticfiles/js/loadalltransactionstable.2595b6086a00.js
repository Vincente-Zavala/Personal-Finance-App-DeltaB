...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    document.addEventListener("click", (e) => {
        ...
        if (editBtn) {
            ...
            typeSelect.addEventListener("change", () => {
                ...
                Array.from(categorySelect.options).forEach(option => {
                    ...
                    const matches =
                        option.dataset.categorytype.toLowerCase() === selectedType;
            
                    option.hidden = !matches;
                    option.disabled = !matches;
            
                    if (matches && option.value === row.dataset.originalCategory) {
                        categorySelect.value = option.value;
                        hasVisibleOption = true;
                    }
                });
            
                // If original category doesn’t belong to new type
                if (!hasVisibleOption) {
        ...
        if (cancelBtn) {
            ...
            const categorySelect = row.querySelector('select[name="category"]');
            const categoryDisplay = row.querySelector('.tx-display');
