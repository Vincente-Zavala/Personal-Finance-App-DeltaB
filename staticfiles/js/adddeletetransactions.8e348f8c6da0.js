document.addEventListener("DOMContentLoaded", function () {
    ...
    confirmImportBtn.onclick = function(e) {
        ...
        console.log("Continue clicked — submitting to:", duplicatesSubmitUrl);
    };
    console.log("confirmImportBtn =", confirmImportBtn);
    ...
    function sendFormAJAX(actionUrl, isSubmitNew) {
        ...
        .then(data => {
            if (data.status === "ok") {
                ...
                tbody.innerHTML = "";   // IMPORTANT: clear table first
                ...
                // IMPORTANT: REMOVE OLD LISTENERS AND ADD ONLY ONE
                const confirmBtn = document.getElementById("confirmImportBtn");
                confirmBtn.replaceWith(confirmBtn.cloneNode(true));   // removes all listeners
                const newConfirmBtn = document.getElementById("confirmImportBtn");
            
                newConfirmBtn.addEventListener("click", function (e) {
                    e.preventDefault();
                    console.log("Continue clicked — submitting...");
