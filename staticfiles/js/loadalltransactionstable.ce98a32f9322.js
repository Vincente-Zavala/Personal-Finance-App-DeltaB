...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    document.addEventListener("click", (e) => {
        ...
        if (cancelBtn) {
            ...
            const categorySelect = row.querySelector('select[name="category"]');
            const categoryDisplay = row.querySelector('.category-col .tx-display');
            console.log("categoryDisplay", categoryDisplay)
            
            console.log("categorySelect 2", categorySelect)
            console.log("original", row.dataset.originalCategory);
            console.log("current", categorySelect.value);
