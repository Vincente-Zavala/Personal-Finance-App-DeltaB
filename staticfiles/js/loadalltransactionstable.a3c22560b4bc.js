    ...
    fetch(ALL_TRANSACTIONS_API_URL, { credentials: "same-origin" })
        ...
        .then(data => {
            ...
            data.transactions.forEach(tx => {
                ...
                checkboxTd.className = "editcol";


                const checkbox = document.createElement("input");
                checkbox.type = "checkbox";
                checkbox.className = "form-check-input tx-input d-none";
                checkbox.name = "selectedtransactions";
                ...
                tr.append(
                    ...
                    categoryTd,
                    noteTd,
                    document.createElement("td"), // account if needed
                    amountTd
                );
