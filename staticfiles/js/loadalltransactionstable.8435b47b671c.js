    ...
    fetch(ALL_TRANSACTIONS_API_URL, { credentials: "same-origin" })
        ...
        .then(data => {
            ...
            data.transactions.forEach(tx => {
                ...
                dateDisplay.className = "tx-display fw-semibold text-primary";
                dateDisplay.textContent = tx.formatted_date;
            
                const dateInput = document.createElement("input");
                dateInput.type = "date";
                dateInput.value = tx.formatted_date;
                dateInput.className = "form-control form-control-sm text-end tx-input d-none";
                dateInput.name = "date";
...
document.addEventListener("click", (e) => {
    ...
    if (cancelBtn) {
        ...
        const dateDisplay = dateInput?.previousElementSibling;
