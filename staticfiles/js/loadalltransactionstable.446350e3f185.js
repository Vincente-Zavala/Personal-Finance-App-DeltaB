// -------------------------
// GLOBAL CACHE FOR TYPES AND CATEGORIES
// -------------------------
let CATEGORY_TYPES = [];

// Load categories into CATEGORY_TYPES (call this once before rendering dropdowns)
function loadCategoryTypes(categoriesData) {
    CATEGORY_TYPES = categoriesData || [];
}

// Build a type dropdown for a transaction
function createTypeDropdown(tx) {
    const select = document.createElement("select");
    select.className = "form-select form-select-sm type-select tx-input d-none"; // hidden by default
...
// Build a category dropdown filtered by type
function createCategoryDropdown(tx, selectedType) {
    const select = document.createElement("select");
    select.className = "form-select form-select-sm category-select tx-input d-none"; // hidden by default
