    ...
    function sendFormAJAX(actionUrl, isSubmitNew) {
        ...
        .then(data => {
            if (data.status === "ok") {
                ...
                tbody.innerHTML = ""; // Clear old duplicates
                ...
                if (confirmImportBtn) {
                    confirmImportBtn.onclick = function (e) {
                        ...
                        // Submit the add transaction form to the addtransaction view
                        const addUrl = document.getElementById("addtransactions").getAttribute("formaction");
                        sendFormAJAX(addUrl, true); // isSubmitNew = true
                    };
                }
