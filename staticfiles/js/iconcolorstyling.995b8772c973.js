...
const categoryTypeStyles = {
    ...
    savings: { color: "#004777", icon: "fa-piggy-bank" },
    transfer: { color: "#9CA3AF", icon: "fa-right-left" },
    debt: { color: "#E59500", icon: "fa-file-invoice-dollar" },
    investment: { color: "#BE609D", icon: "fa-chart-line" },
    refund: { color: "#8B5CF6", icon: "fa-rotate-left" },
    retirement: { color: "#470024", icon: "fa-umbrella-beach" },
  };
