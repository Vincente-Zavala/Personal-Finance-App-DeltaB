...
const categoryTypeStyles = {
    income: { color: "#28A90F", icon: "fa-arrow-trend-up" },
    ...
    debt: { color: "#EB1616", icon: "fa-file-invoice-dollar" },
    investment: { color: "#1443EB", icon: "fa-chart-line" },
    refund: { color: "#8B5CF6", icon: "fa-rotate-left" },
    retirement: { color: "#1443EB", icon: "fa-umbrella-beach" },
  };
