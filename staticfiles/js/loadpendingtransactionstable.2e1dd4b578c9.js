...
document.addEventListener("change", function(e) {
    ...
    if (target.classList.contains("type-select")) {
        ...
        // If user selects default "Select Type", hide category dropdown
        if (!target.value) {
            ...
            const hiddenDestination = buildDestinationSelect({id: transactionId, category_name: ""}, null);
            categoryTd.innerHTML = "";
            categoryTd.appendChild(hiddenDestination);
            return;
        }
