...
document.addEventListener("DOMContentLoaded", async () => {
            ...
            data.transactions.forEach(tx => {
                ...
                <td class="editcol" hidden>
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <button
                            class="btn btn-sm btn-outline-danger tx-button p-0 d-none"
                            data-tx-id="${tx.id}"
                            type="button">
                        ...
                        <button
                            class="btn btn-sm btn-outline-primary tx-button p-0 d-none"
                            data-tx-id="${tx.id}"
                            type="button">
    ...
    document.addEventListener("click", (e) => {
        ...
        const cancelBtn = e.target.closest(".tx-button .fa-xmark, .tx-button");
        const saveBtn = e.target.closest(".tx-button .fa-check, .tx-button");
        ...
        if (editBtn) {
            ...
            inputs.forEach(input => {
                originalData[input.name || input.className] = input.value;
            });
        ...
        if (saveBtn) {
            ...
            const row = saveIcon.closest(".transaction-row");
            if (!row) return;
            ...
            inputs.forEach(input => {
                ...
                if (input.value != original[input.name]) {
