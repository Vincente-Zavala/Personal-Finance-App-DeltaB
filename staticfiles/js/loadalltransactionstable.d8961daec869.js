...
document.addEventListener("click", (e) => {
    ...
    if (cancelBtn) {
        ...
        const dateDisplay = dateInput.previousElementSibling; // span right before input

        if (dateInput && dateDisplay) {
            dateInput.value = dateInput.dataset.originalValue; // revert input
            dateDisplay.textContent = dateInput.dataset.originalValue; // revert display
            dateInput.classList.add("d-none");  // hide input
            dateDisplay.classList.remove("d-none"); // show span
        }
