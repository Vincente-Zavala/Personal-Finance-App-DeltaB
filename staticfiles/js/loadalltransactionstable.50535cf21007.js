    ...
    fetch(ALL_TRANSACTIONS_API_URL, { credentials: "same-origin" })
        ...
        .then(data => {
            ...
            data.transactions.forEach(tx => {
                ...
                dateInput.type = "date";
                dateInput.value = tx.date; // use ISO format yyyy-mm-dd
                dateInput.className = "form-control form-control-sm tx-input d-none";
                dateInput.name = "date";
...
document.addEventListener("click", (e) => {
    ...
    //     // Rebuild category select with original type
    ...
    //     restoredCategorySelect.classList.add("tx-input");
    //     restoredCategorySelect.classList.add("d-none"); // hide until edit mode
    ...
    //     if (typeDisplay) typeDisplay.textContent = row.dataset.originalType;
    ...
    if (cancelBtn) {
        ...
        const dateDisplay = row.querySelector('td:first-child .tx-display'); // adjust selector if needed
        if (dateInput && dateDisplay) {
            dateInput.value = dateInput.dataset.originalValue; // stored when entering edit mode
            dateInput.classList.add("d-none"); // hide input
            dateDisplay.classList.remove("d-none"); // show display
        }
